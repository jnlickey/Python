#!/usr/bin/python -tt
# Creates email list of Junior's that can
...
inFile = open("junior.CSV",'r+')
outFile = open("JUNIOR_STUDENTS.csv",'r+')

#listIDs = []

outFile.write('dn: cn=jr_cos, ou=Aliases, dc=cse, dc=example, dc=com\n')

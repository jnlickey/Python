...
def create_user(username,display_name,uid_Number,disabled,gecos,uHomeDir,passwd):
    ...
    dn = '"CN={},OU=TIS_Infra,DC=ad,DC=cll,DC=cloud"'.format(username,users_ou)
...
if __name__ == "__main__":
    domain_controller = 'DC=ad,DC=cll,DC=cloud'
    users_ou = 'OU=TIS_Infra,{}'.format(domain_controller)
    groups_ou = 'OU=Groups,OU=TIS_Infra,{}'.format(domain_controller)
    pwd_length = 10
    name = []
